...
meta_title: "AI Use Case Discovery Interview Template | Kowalah"
description: "Structured interview framework for identifying AI opportunities across functional teams. Discover high-impact use cases through systematic discovery conversations with employees."
...
overview:
  ...
  when_to_use: "During AI adoption planning, organizational transformation initiatives, or when systematically identifying AI use cases across business units"
  key_benefit: "Transform vague 'we should use AI' aspirations into concrete, high-impact use cases grounded in actual employee workflows and pain points"
  sections_included:
...
how_to_use:
  ...
  steps:
    - title: "Download or copy the template"
      description: "Use the Google Docs link to make a copy, or copy the content directly from this page"
      icon: "document-duplicate"
    - title: "Schedule discovery interviews"
      description: "Book 30-45 minute conversations with employees across different functions and seniority levels"
      icon: "calendar"
    - title: "Conduct structured interviews"
      description: "Follow the framework to explore daily, weekly, monthly, and irregular tasks systematically"
      icon: "chat-bubble-left-right"
    - title: "Synthesize findings and prioritize"
      description: "Aggregate insights across interviews to identify high-frequency pain points and quick-win AI opportunities"
      icon: "table-cells"
faq:
  title: "Frequently Asked Questions"
  subtitle: "Common questions about conducting AI use case discovery interviews"
  questions:
    - question: "How many people should I interview to get meaningful results?"
    ...
    - question: "Should I interview senior leaders or individual contributors first?"
...
***NOTE**: To use this template, copy the content using the "Copy page" button above, open the Google Doc to make your own copy, or customize the framework below for your organization.*

# Functional Team AI Use Case Discovery
...
**Thank Them:**
Express genuine appreciation for their time and insights. Make it clear their participation matters.
