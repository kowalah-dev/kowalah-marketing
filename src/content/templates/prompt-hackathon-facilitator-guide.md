...
meta_title: "Prompt Writing Hackathon Facilitator Guide | Kowalah"
description: "Complete facilitator guide for running hands-on AI prompt writing hackathons. Transform your team's AI capabilities in 2 hours with this step-by-step workshop framework."
...
overview:
  ...
  when_to_use: "When you need to accelerate AI adoption through practical skill-building; when teams need hands-on experience with prompt engineering; when you want to create immediate productivity gains while building foundational AI capabilities"
  key_benefit: "A complete, battle-tested framework to facilitate engaging 2-hour workshops where every participant develops production-ready AI prompts for their actual work processes"
  sections_included:
...
how_to_use:
  ...
  steps:
    - title: "Access the complete guide"
      description: "Click the link below to access the full Google Doc with all planning materials, scripts, and templates"
      icon: "document-duplicate"
    - title: "Make a copy for your organization"
      description: "Create your own copy (File > Make a Copy) and customize for your company context and team needs"
      icon: "pencil-square"
    - title: "Plan your first hackathon"
      description: "Follow the 2-week planning timeline, selecting participants from a single team or function for best results"
      icon: "calendar"
    - title: "Run and iterate"
      description: "Facilitate your first workshop, gather feedback, and refine for subsequent hackathons across your organization"
      icon: "rocket-launch"
faq:
  title: "Frequently Asked Questions"
  subtitle: "Everything you need to know about running successful prompt hackathons"
  questions:
    - question: "Do I need to be an AI expert to facilitate this workshop?"
      answer: "No! This guide is specifically designed for business professionals with no technical or AI expertise. The ideal facilitator understands business processes, can guide group discussions, and can follow structured timing. The guide provides everything you need including scripts, talking points, and examples. If you can facilitate a workshop and understand how work gets done in your organization, you can run this hackathon."
    - question: "How many participants should I include in each hackathon?"
    ...
    - question: "What AI platforms can participants use during the hackathon?"
    ...
    - question: "What happens after the first hackathon? How do I scale this across my organization?"
    ...
    - question: "What if participants get stuck or can't think of a good use case during the workshop?"
...
external_resources:
  google_doc:
    url: "https://docs.google.com/document/d/1an_ES8gUTB7_bHTlgYMIRlGuHOgN15KgQZ5xXCdHjZI/edit?usp=sharing"
    label: "Open Full Guide in Google Docs"
cta:
  title: "Need Help Accelerating AI Adoption Across Your Organization?"
  content: "While this guide provides everything you need to run successful prompt hackathons, Kowalah's Digital Chief AI Officer can help you develop comprehensive AI training strategies, build organizational capabilities at scale, and ensure your workshops connect to broader AI transformation initiatives."
...
***NOTE**: This template links to a comprehensive Google Doc with all facilitator materials, scripts, and templates. Make a copy for your organization and customize as needed.*

# Prompt Writing Hackathon Facilitator Guide
...
**[Access the full Prompt Hackathon Facilitator Guide on Google Docs →](https://docs.google.com/document/d/1an_ES8gUTB7_bHTlgYMIRlGuHOgN15KgQZ5xXCdHjZI/edit?usp=sharing)**
