...
challenges:
  title: "The AI Investment Gap"
  subtitle: "You've invested in AI—licenses, training, consultants. But where's the business impact?"
  items:
    - title: "The Enthusiasm Gap"
      description: "Training created excitement, but not execution. Teams are back to old ways within weeks."
      icon: "graph"
      category: "strategic"
    - title: "Ideas Without Implementation"
      description: "People have great AI ideas, but they're stuck in backlogs—competing with 'real work' until enthusiasm dies."
      icon: "profile"
      category: "operational"
    - title: "Platform Confusion"
      description: "ChatGPT, Copilot, Claude, Gemini—which one? Different teams using different tools with no clear strategy."
      icon: "speed"
      category: "competitive"

solution:
  title: "Build First. Train Second. Keep Delivering."
  content: "We flip the traditional AI approach. Instead of training everyone and hoping they figure it out, we embed with your key people, build solutions that deliver value, then scale with real internal examples."
...
benefits:
  ...
  subtitle: "We don't measure success by training completion rates. We measure it by business impact."
  points:
    ...
    - title: "Training That Actually Sticks"
      content: "When training includes 'Here's what Sarah in Finance built,' it's infinitely more powerful than generic prompting tutorials. Internal examples make possibilities concrete."
      image: "/images/solutions/ceo-competitive-speed.png"
      metric: "Internal proof points"
    - title: "Ideas That Get Built"
      content: "Expert Requests turn your team's AI ideas into working solutions—without overwhelming IT or waiting in backlogs. Innovation flows, enthusiasm stays high."
